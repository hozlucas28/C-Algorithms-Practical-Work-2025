...
int main(int argc, char *argv[]) {
    ...
    CURL_IGNORE_DEPRECATION(
        ...
        curl_formadd(&formpost, &lastptr, CURLFORM_COPYNAME, "sendfile", CURLFORM_FILE,
                     "postit2-formadd.c", CURLFORM_END);
        ...
        curl_formadd(&formpost, &lastptr, CURLFORM_COPYNAME, "submit", CURLFORM_COPYCONTENTS,
                     "send", CURLFORM_END);)
    ...
    if (curl) {
        ...
        CURL_IGNORE_DEPRECATION(curl_easy_setopt(curl, CURLOPT_HTTPPOST, formpost);)
