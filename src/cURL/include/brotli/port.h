...
#define BROTLI_MSVC_VERSION                                                              \
    BROTLI_MAKE_VERSION((_MSC_FULL_VER / 10000000), (_MSC_FULL_VER % 10000000) / 100000, \
                        (_MSC_FULL_VER % 100000) / 100)
#elif defined(_MSC_FULL_VER)
#define BROTLI_MSVC_VERSION                                                           \
    BROTLI_MAKE_VERSION((_MSC_FULL_VER / 1000000), (_MSC_FULL_VER % 1000000) / 10000, \
...
#define BROTLI_INTEL_VERSION \
    BROTLI_MAKE_VERSION(__INTEL_COMPILER / 100, __INTEL_COMPILER % 100, __INTEL_COMPILER_UPDATE)
...
#define BROTLI_SUNPRO_VERSION                                                           \
    BROTLI_MAKE_VERSION((((__SUNPRO_C >> 16) & 0xf) * 10) + ((__SUNPRO_C >> 12) & 0xf), \
                        (((__SUNPRO_C >> 8) & 0xf) * 10) + ((__SUNPRO_C >> 4) & 0xf),   \
                        (__SUNPRO_C & 0xf) * 10)
#elif defined(__SUNPRO_C)
#define BROTLI_SUNPRO_VERSION \
    BROTLI_MAKE_VERSION((__SUNPRO_C >> 8) & 0xf, (__SUNPRO_C >> 4) & 0xf, (__SUNPRO_C) & 0xf)
#elif defined(__SUNPRO_CC) && (__SUNPRO_CC > 0x1000)
#define BROTLI_SUNPRO_VERSION                                                             \
    BROTLI_MAKE_VERSION((((__SUNPRO_CC >> 16) & 0xf) * 10) + ((__SUNPRO_CC >> 12) & 0xf), \
                        (((__SUNPRO_CC >> 8) & 0xf) * 10) + ((__SUNPRO_CC >> 4) & 0xf),   \
                        (__SUNPRO_CC & 0xf) * 10)
#elif defined(__SUNPRO_CC)
#define BROTLI_SUNPRO_VERSION \
    BROTLI_MAKE_VERSION((__SUNPRO_CC >> 8) & 0xf, (__SUNPRO_CC >> 4) & 0xf, (__SUNPRO_CC) & 0xf)
#endif
...
#define BROTLI_ARM_VERSION                                                                \
    BROTLI_MAKE_VERSION((__ARMCC_VERSION / 1000000), (__ARMCC_VERSION % 1000000) / 10000, \
...
#define BROTLI_IBM_VERSION \
    BROTLI_MAKE_VERSION(__ibmxl_version__, __ibmxl_release__, __ibmxl_modification__)
...
#define BROTLI_IAR_VERSION \
    BROTLI_MAKE_VERSION((__VER__ / 1000000), (__VER__ / 1000) % 1000, (__VER__ % 1000))
#else
...
#elif BROTLI_GNUC_VERSION_CHECK(3, 3, 0) || BROTLI_TI_VERSION_CHECK(8, 0, 0) ||    \
    BROTLI_INTEL_VERSION_CHECK(16, 0, 0) || BROTLI_ARM_VERSION_CHECK(4, 1, 0) ||   \
...
#define BROTLI_INTERNAL
    ...
    !defined(__cplusplus) && !defined(__PGI) && !defined(__PGIC__) && !defined(__TINYC__) &&   \
    !defined(__clang__)
