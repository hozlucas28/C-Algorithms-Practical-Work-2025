...
/* Compile-time deprecation macros. */
     ...
     (defined(__clang__) && __clang_major__ >= 3) || defined(__IAR_SYSTEMS_ICC__)) &&         \
    !defined(__INTEL_COMPILER) && !defined(CURL_DISABLE_DEPRECATION) && !defined(BUILDING_LIBCURL)
...
/* HP-UX systems version 9, 10 and 11 lack sys/select.h and so does oldish
   ...
   require it! */
    ...
    defined(__INTEGRITY) || defined(ANDROID) || defined(__ANDROID__) || defined(__OpenBSD__) || \
    defined(__CYGWIN__) || defined(AMIGA) || defined(__NuttX__) ||                              \
    (defined(__FreeBSD_version) && (__FreeBSD_version < 800000)) ||                             \
    (defined(__MidnightBSD_version) && (__MidnightBSD_version < 100000)) || defined(__sun__) || \
    defined(__serenity__) || defined(__vxworks__)
...
typedef enum {
     ...
     * prototype defines. */
    CURLOPTDEPRECATED(CURLOPT_PROGRESSFUNCTION, CURLOPTTYPE_FUNCTIONPOINT, 56, 7.32.0,
...
#define CURLOPT_PROGRESSDATA CURLOPT_XFERINFODATA
    ...
    */
    ...
    CURLOPTDEPRECATED(CURLOPT_IOCTLFUNCTION, CURLOPTTYPE_FUNCTIONPOINT, 130, 7.18.0,
    ...
    */
    ...
    CURLOPTDEPRECATED(CURLOPT_CONV_FROM_NETWORK_FUNCTION, CURLOPTTYPE_FUNCTIONPOINT, 142, 7.82.0,
                      "Serves no purpose anymore"),

    /* Function that will be called to convert to the
       network encoding (instead of using the iconv calls in libcurl) */
    CURLOPTDEPRECATED(CURLOPT_CONV_TO_NETWORK_FUNCTION, CURLOPTTYPE_FUNCTIONPOINT, 143, 7.82.0,
                      "Serves no purpose anymore"),

    /* Function that will be called to convert from UTF8
       (instead of using the iconv calls in libcurl)
       Note that this is used only for SSL certificate processing */
    CURLOPTDEPRECATED(CURLOPT_CONV_FROM_UTF8_FUNCTION, CURLOPTTYPE_FUNCTIONPOINT, 144, 7.82.0,
                      "Serves no purpose anymore"),
    ...
    /* Socks Service */
    /* DEPRECATED, do not use! */
    CURLOPTDEPRECATED(CURLOPT_SOCKS5_GSSAPI_SERVICE, CURLOPTTYPE_STRINGPOINT, 179, 7.49.0,
...
typedef enum {
    ...
    CURLINFO_SIZE_DOWNLOAD CURL_DEPRECATED(7.55.0, "Use CURLINFO_SIZE_DOWNLOAD_T") =
        CURLINFO_DOUBLE + 8,
    CURLINFO_SIZE_DOWNLOAD_T = CURLINFO_OFF_T + 8,
    CURLINFO_SPEED_DOWNLOAD CURL_DEPRECATED(7.55.0, "Use CURLINFO_SPEED_DOWNLOAD_T") =
        CURLINFO_DOUBLE + 9,
    ...
    CURLINFO_CONTENT_LENGTH_UPLOAD CURL_DEPRECATED(7.55.0, "Use CURLINFO_CONTENT_LENGTH_UPLOAD_T") =
        CURLINFO_DOUBLE + 16,
 ...
 */
CURL_EXTERN CURLcode curl_easy_ssls_import(CURL *handle, const char *session_key,
...
typedef CURLcode curl_ssls_export_cb(CURL *handle, void *userptr, const char *session_key,
                                     const unsigned char *shmac, size_t shmac_len,
                                     const unsigned char *sdata, size_t sdata_len,
 ...
 *
 */
CURL_EXTERN CURLcode curl_easy_ssls_export(CURL *handle, curl_ssls_export_cb *export_fn,
                                           void *userptr);
